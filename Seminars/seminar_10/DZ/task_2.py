...
class Bankomat:
    ...
    def __init__(self, account_num: int, name_bank: str, percent_take: float = 0.015,
                 percent_add: float = 0.03, percent_tax: float = 0.01):
    ...
    def exit_bank(self):
        print("Будем рады видетеь Вас снова!\n")
        exit()
